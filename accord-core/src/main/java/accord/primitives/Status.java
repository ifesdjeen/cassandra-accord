...
public enum Status
{
    ...
    Accepted          (Accept,    ACCEPTED,                                CoveringRoute,          DefinitionUnknown, ExecuteAtProposed,     DepsProposedFixed, Unknown), // may or may not have witnessed
    ...
    static
    {
        ...
        Invariants.partiallyOrdered(PreNotAccepted, NotAccepted, AcceptedInvalidate, Accepted);
    }
