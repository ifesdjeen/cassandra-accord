...
public class Deps
{
    ...
    public final KeyDeps keyDeps; // key dependencies we will track via CommandsForKey
    public final RangeDeps rangeDeps;
    public final KeyDeps directKeyDeps; // key dependencies we will track via direct dependency relationships
