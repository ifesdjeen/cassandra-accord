...
public enum SaveStatus
{
    ...
    PreNotAcceptedWithVote          (Status.PreNotAccepted,                                                                                                 VotePreAccept),
    PreNotAcceptedWithDeps          (Status.PreNotAccepted,         FullRoute,  DefinitionUnknown,  ExecuteAtUnknown,   DepsFromCoordinator,Unknown,        VotePreAccept),
    ...
    NotAcceptedWithVote             (Status.NotAccepted,                                                                                                    VotePreAccept),
    NotAcceptedWithDeps             (Status.NotAccepted,            FullRoute,  DefinitionUnknown,  ExecuteAtUnknown,   DepsFromCoordinator,Unknown,        VotePreAccept),
    ...
    AcceptedWithDefinition          (Status.Accepted,               FullRoute,  DefinitionKnown,    ExecuteAtProposed,  DepsProposedFixed,  Unknown),
            ...
            else
            {
                switch (status)
                {
                    ...
                    case PreNotAccepted:
                        ...
                        return known.is(NoVote) ? PreNotAccepted : known.is(DepsUnknown) ? PreNotAcceptedWithVote : PreNotAcceptedWithDeps;
                    case NotAccepted:
                        if (known.isDefinitionKnown())
                            return known.is(NoVote) ? NotAcceptedWithDefinition : known.is(DepsUnknown) ? NotAcceptedWithDefAndVote : NotAcceptedWithDefAndDeps;
                        return known.is(NoVote) ? NotAccepted : known.is(DepsUnknown) ? NotAcceptedWithVote : NotAcceptedWithDeps;
                    case Accepted:
                        return known.isDefinitionKnown() ? AcceptedWithDefinition : Accepted;
                    case AcceptedSlow:
                        return known.isDefinitionKnown() ? AcceptedSlowWithDefinition : AcceptedSlow;
                    case AcceptedInvalidate:
